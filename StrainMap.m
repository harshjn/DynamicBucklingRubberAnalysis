% This function takes in a voltage value of strain and gives back a mm Position

function yOut = StrainMap(StrainVolts,MaxMin)
...
yOut=interp1(A,DistMat,StrainVolts);
end
